...
public class PlayerManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        p1Transform.position = mapManager.MapToWorld(mapManager.Dimensions.y + 0.6f-3, mapManager.Dimensions.x + 0.5f-3);
        ...
        p2.transform.position = mapManager.MapToWorld(2.6f,2.5f);
