...
public class CopySpriteSlicing : EditorWindow
{
    ...
    private void CopySlicingData(Texture2D source, Texture2D target)
    {
        ...
        // 1. Configure the Target to match the Source's Sprite Mode
        ...
        // 2. Copy the SpriteSheet (The list of slices/names)
        // Note: We create a deep copy of the array so we don't reference the old objects
